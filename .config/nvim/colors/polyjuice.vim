...
" Last Updated: Fri 08 May 2020 12:15:14 PM CEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Mode guifg=#1d2021 guibg=#89b594 guisp=NONE gui=bold cterm=bold
  hi Column guifg=#7cafa3 guibg=#1d2021 guisp=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#ebdbb2 guibg=#7c6f64 guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Mode ctermbg=71 cterm=bold
  hi Column ctermfg=30 cterm=NONE
  hi StatusLine ctermfg=229 ctermbg=243 cterm=NONE
...
if s:t_Co >= 8
  ...
  hi Mode ctermfg=Black ctermbg=Green cterm=bold
